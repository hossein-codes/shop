...
| **قیمت** | سرمه‌ای، SemiBold | قیمت هرگز رنگی نیست |
| **تخفیف** | آجری `#C0392B`: درصد + قیمت خط‌خورده + بج `brick-soft`/`brick` | تنها قرمزِ مجاز در صفحه؛ فقط روی قیمت — هرگز دکمه، هرگز تیتر |
...
| نوع | ظاهر | معنا |
|---|---|---|
| جدید | متن سفید روی آبی برند | ثبت‌شده در ۱۴ روز اخیر |
