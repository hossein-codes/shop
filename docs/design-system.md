...
| **قیمت** | فقط یک عدد؛ عادی: سرمه‌ای Bold · تخفیف‌خورده: **آبی برند** Bold + مربع کوچک `brick-soft` با درصد | قیمت خط‌خورده ⛔ در کارت؛ در کارت قیمت سمت چپ می‌نشیند |
...
- **v3.3 — ۲۰۲۶-۰۸-۲۲ — پالایش کارت و قیمت (بازخورد کارفرما):** نمایش قیمت فقط «یک» عدد: قیمت قابل پرداخت (تخفیف‌خورده = آبی برند) + **مربع کوچک قرمز ملایم** (`brick-soft`/`brick`) با درصد تخفیف — قیمت خط‌خورده حذف شد · قیمت به **سمت چپ** کارت منتقل شد · نقطه‌های رنگ از کارت حذف شدند (خطوط رنگی اضافه) · بج تخفیف روی تصویر حذف شد (درصد فقط کنار قیمت — یک‌بار) · قلب پررنگ‌تر شد: پس‌زمینه سفید توپُر + حاشیه `line-strong` + سایه (روی عکس‌های روشن گم نمی‌شد) · تمام تصاویر دمو به فایل‌های محلی مهاجرت کردند (پیش‌نمایش آفلاین).
